  ...
  return (
    <div className="bg-gray-100 min-h-screen py-10">
      <div className="container mx-auto px-4">
        ...
        <h3 className="text-2xl font-semibold mb-4">4. Content and Reviews</h3>
        <p className="text-gray-700 mb-4">
        ...
        <h3 className="text-2xl font-semibold mb-4">7. Privacy Policy</h3>
        <p className="text-gray-700 mb-4">
        ...
        <h3 className="text-2xl font-semibold mb-4">8. Termination of Use</h3>
        <p className="text-gray-700 mb-4">
