    ...
    <>
      <div className="px-8 md:px-8  relative">
        ...
        <ul className="flex flex-wrap gap-3 border-2">
          ...
          <Image width={800} height={800} className="w-full  h-[22rem] md:h-auto " src="https://res.cloudinary.com/dznz3eqe8/image/upload/v1742280826/GalleryImage_yf5lo5.jpg" alt="GalleryImage" />
