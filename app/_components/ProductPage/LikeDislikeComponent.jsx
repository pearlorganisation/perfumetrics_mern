...
const LikeDislikeComponent = React.memo(({ historyMap, productId, data }) => {
  ...
  return (
    <div className="flex  justify-center text-xs  mt-12  md:mt-6  ">
      <div
        onClick={handleLike}
      ...
      >
        ...
        <div className="h-1 w-full md:w-[40%] bg-pink-400"></div>
      ...
      <div
        ...
        className=" w-fit  cursor-pointer grid place-items-center gap-1 ml-10 space-y-1"
      >
        <div className='relative'>
          {
            isLoading ? <div className='absolute w-full h-full border-t-2 animate-spin rounded-full border-pink-500'>
