...
const News = () => {
    return (
        <div className="space-y-4">
            <div className="flex justify-between items-center text-lg md:text-4xl font-medium">
                News{" "}
            ...
            <div className='grid gap-6 md:grid-cols-[18rem_auto] py-6 '>
                <div>
                    <div>
                        ...
                        <div className='font-semibold'>A Perfume</div>
                        <p className='font-medium'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ratione qui quis animi id nisi doloribus, quibusdam tenetur maiores sit nihil assumenda sed </p>
                    </div>
                    <div>
                        <img className='rounded-md' src="https://images.unsplash.com/photo-1624613533305-28d421d70875?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fHBlcmZ1bWV8ZW58MHx8MHx8fDA%3D" alt="" />
                        <div className='font-semibold'>A Perfume</div>
                ...
                <div className=' space-y-3'>
                    <img className='w-full rounded-md' src="https://plus.unsplash.com/premium_photo-1667161521640-bba57df66f29?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDF8fHBlcmZ1bWV8ZW58MHx8MHx8fDA%3D" alt="" />
                    <p className='font-bold'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ratione qui quis animi id nisi doloribus, quibusdam tenetur maiores sit nihil assumenda sed </p>
            ...
            <div className='grid md:grid-cols-[40%_auto] gap-3 border-y-2 py-8 border-gray-400'>
                ...
                <img src="https://images.unsplash.com/photo-1702165642103-454c1b251c9f?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTUyfHxwZXJmdW1lfGVufDB8fDB8fHww" alt="" />
            </div>
